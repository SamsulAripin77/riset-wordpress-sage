...
@section('content')
    ...
    <section id="hero" class="relative h-screen text-center flex flex-col justify-end text-surface">
        ...
        <div class="relative container mx-auto px-4 pb-20 md:pb-24">
            <div class="max-w-3xl mx-auto">
                <p class="mt-4 text-lg font-semibold text-surface">Kami hadir untuk menyederhanakan masalah hukum Anda dengan pendekatan yang cermat dan profesional.</p>
                <a href="#services" class="mt-8 inline-block bg-secondary text-surface py-3 px-8 rounded-full text-lg hover:bg-primary transition-colors">Hubungi Kami</a>
            </div>
        </div>
    </section>
    ...
    <section id="services" class="bg-background py-16 md:py-24 text-primary">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl md:text-4xl font-bold text-center mb-12 text-primary">Solusi Hukum yang Beragam untuk Setiap Kebutuhan</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-surface p-6 md:p-8 rounded-lg shadow-md">
                    ...
                    <p class="text-primary">Kami membantu perusahaan dalam pembentukan, restrukturisasi, dan kepatuhan regulasi, memastikan bisnis Anda beroperasi secara legal dan efisien.</p>
                </div>
                <!-- Layanan 2 -->
                <div class="bg-surface p-6 md:p-8 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold mb-2">Litigasi & Penyelesaian Sengketa</h3>
                    <p class="text-primary">Tim litigasi kami siap mewakili Anda di pengadilan dan arbitrase untuk menyelesaikan sengketa dengan strategi yang efektif.</p>
                </div>
                <!-- Layanan 3 -->
                <div class="bg-surface p-6 md:p-8 rounded-lg shadow-md">
                    <h3 class="text-xl font-semibold mb-2">Kekayaan Intelektual (IPR)</h3>
                    <p class="text-primary">Lindungi aset intelektual Anda. Kami menyediakan layanan pendaftaran merek dagang, hak cipta, dan paten.</p>
                </div>
            ...
            <div class="relative max-w-4xl mx-auto">
                ...
                <div class="mb-8 flex justify-between items-center w-full right-timeline">
                    ...
                    <div class="order-1 bg-background rounded-lg shadow-xl w-full md:w-5/12 px-6 py-4">
                        ...
                        <p class="text-sm leading-snug tracking-wide text-primary text-opacity-100">Ambara Advocate resmi didirikan dengan komitmen untuk memberikan layanan hukum terbaik.</p>
                    </div>
                </div>
                <!-- Timeline Item 2 -->
                <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                    ...
                    <div class="order-1 bg-background rounded-lg shadow-xl w-full md:w-5/12 px-6 py-4">
                        ...
                        <p class="text-sm leading-snug tracking-wide text-primary text-opacity-100">Kami memperluas cakupan layanan untuk mencakup area Hukum Korporat dan Kekayaan Intelektual.</p>
                    </div>
                </div>
    ...
    <section id="contact" class="bg-surface py-16 md:py-24 text-primary">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-lg mb-8 text-secondary">Jika Anda membutuhkan konsultasi, silakan hubungi kami. Tim kami akan segera menanggapi pertanyaan Anda.</p>
            <form class="max-w-xl mx-auto space-y-4">
                <input type="text" placeholder="Nama Lengkap" class="w-full p-3 rounded-lg text-primary bg-background border border-secondary">
                <input type="email" placeholder="Email" class="w-full p-3 rounded-lg text-primary bg-background border border-secondary">
                <textarea placeholder="Pesan Anda" rows="4" class="w-full p-3 rounded-lg text-primary bg-background border border-secondary"></textarea>
                <button type="submit" class="w-full bg-secondary py-3 rounded-lg font-semibold text-surface hover:bg-primary transition-colors">Kirim Pesan</button>
            </form>
        </div>
    </section>
