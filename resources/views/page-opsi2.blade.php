...
<head>
    ...
    <style>
        :root {
            ...
            --text-secondary: #4B5567; /* gray-600 */
...
<body>
    ...
    <header id="main-header" class="fixed top-0 left-0 w-full z-50 transition-colors duration-300">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-8 text-sm font-medium">
                <a href="#about" class="nav-link hover:text-[var(--accent)] transition-colors">Firma Kami</a>
                <a href="#services" class="nav-link hover:text-[var(--accent)] transition-colors">Layanan</a>
                <a href="#team" class="nav-link hover:text-[var(--accent)] transition-colors">Pengacara</a>
                <a href="#awards" class="nav-link hover:text-[var(--accent)] transition-colors">Pengakuan</a>
                <a href="#articles" class="nav-link hover:text-[var(--accent)] transition-colors">Publikasi</a>
            </nav>
    ...
    <main>
        ...
        <section id="hero" class="relative h-screen flex items-center justify-center">
            ...
            <!-- Overlay -->
            <div class="absolute top-0 left-0 w-full h-full bg-[var(--text-primary)] opacity-50 -z-10"></div>
        ...
        <section id="about" class="bg-[var(--bg-primary)] py-20 md:py-32">
            <div class="container mx-auto px-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="lg:order-1">
                        ...
                        <p class="text-lg text-[var(--text-secondary)] leading-relaxed mb-4">Kami menggabungkan pengalaman dan keahlian dengan standar layanan yang tinggi, didukung oleh inovasi untuk memberikan solusi yang tepat bagi klien.</p>
                        <p class="text-sm text-[var(--text-secondary)]/80 leading-relaxed">Pengacara kami menggabungkan keahlian lokal dan internasional. Kami berkomitmen untuk memberikan kualitas, etika, dan profesionalisme. Kami fokus pada solusi komprehensif, standar integritas tertinggi, dan tidak pernah mengambil jalan pintas.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="awards" class="bg-[var(--bg-secondary)] py-20 md:py-32">
            <div class="container mx-auto px-6">
                <div class="text-center mb-12">
                    <h4 class="text-sm font-semibold uppercase text-gray-500 mb-2 tracking-widest">PENGAKUAN</h4>
                    <h2 class="text-4xl md:text-6xl font-bold text-[var(--text-primary)]">Diakui secara nasional dan internasional</h2>
                </div>
        ...
        <section id="history" class="bg-[var(--bg-primary)] py-20 md:py-32">
            <div class="container mx-auto px-6">
                <div class="text-center mb-12">
                    <h4 class="text-sm font-semibold uppercase text-gray-500 mb-2 tracking-widest">PERJALANAN KAMI</h4>
                    <h2 class="text-4xl md:text-6xl font-bold text-[var(--text-primary)]">Tonggak Penting</h2>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <!-- Timeline Item 1 -->
                    <div class="bg-[var(--bg-secondary)] p-8 rounded-xl shadow-lg border-l-4 border-[var(--color-primary)] hover:shadow-xl transition-shadow duration-300">
                        <span class="text-4xl font-bold text-gray-400 mb-4 block">1992</span>
                        <h3 class="font-bold text-2xl text-[var(--text-primary)] mb-2">Firma Kami Didirikan</h3>
                    ...
                    <div class="bg-[var(--bg-secondary)] p-8 rounded-xl shadow-lg border-l-4 border-[var(--color-primary)] hover:shadow-xl transition-shadow duration-300">
                        ...
                        <h3 class="font-bold text-2xl text-[var(--text-primary)] mb-2">Ekspansi Regional</h3>
                    ...
                    <div class="bg-[var(--bg-secondary)] p-8 rounded-xl shadow-lg border-l-4 border-[var(--color-primary)] hover:shadow-xl transition-shadow duration-300">
                        ...
                        <h3 class="font-bold text-2xl text-[var(--text-primary)] mb-2">Pengakuan Internasional</h3>
                    ...
                    <div class="bg-[var(--bg-secondary)] p-8 rounded-xl shadow-lg border-l-4 border-[var(--color-primary)] hover:shadow-xl transition-shadow duration-300">
                        ...
                        <h3 class="font-bold text-2xl text-[var(--text-primary)] mb-2">Era Digital</h3>
        ...
        <section id="afiliasi" class="bg-[var(--bg-secondary)] py-20 md:py-32">
            <div class="container mx-auto px-6">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
        ...
        <section id="founder" class="relative py-20 md:py-32 text-white">
            ...
            <div class="absolute inset-0 bg-[var(--text-primary)] opacity-70"></div>
            <div class="relative container mx-auto px-6 text-center">
                ...
                <a href="#" class="inline-block bg-transparent text-white font-semibold py-3 px-8 rounded-full border-2 border-[var(--accent)] hover:bg-[var(--accent)] hover:text-[var(--text-primary)] transition-colors">Pelajari Selengkapnya</a>
            </div>
        </section>

        <!-- Section Artikel - Cards with hover effects -->
        <section id="articles" class="bg-[var(--bg-primary)] py-20 md:py-32">
            <div class="container mx-auto px-6">
                <div class="flex items-center justify-between mb-8">
                    <h4 class="text-sm font-semibold uppercase text-gray-500 tracking-widest">PUBLIKASI & BLOG</h4>
                    <a href="#" class="text-[var(--accent)] font-semibold hover:underline">Lihat Semua &rarr;</a>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <!-- Artikel 1 -->
                    <div class="bg-[var(--bg-secondary)] rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="font-bold text-xl mt-2 mb-2 text-[var(--text-primary)]">Pentingnya Legal Due Diligence dalam M&A.</h3>
                            <a href="#" class="text-[var(--accent)] font-semibold mt-4 hover:underline">Baca Selengkapnya</a>
                        </div>
                    </div>
                    <!-- Artikel 2 -->
                    <div class="bg-[var(--bg-secondary)] rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="font-bold text-xl mt-2 mb-2 text-[var(--text-primary)]">Strategi Efektif dalam Penyelesaian Sengketa.</h3>
                            <a href="#" class="text-[var(--accent)] font-semibold mt-4 hover:underline">Baca Selengkapnya</a>
                        </div>
                    </div>
                    <!-- Artikel 3 -->
                    <div class="bg-[var(--bg-secondary)] rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <h3 class="font-bold text-xl mt-2 mb-2 text-[var(--text-primary)]">Perlindungan Merek Dagang di Era Digital.</h3>
                            <a href="#" class="text-[var(--accent)] font-semibold mt-4 hover:underline">Baca Selengkapnya</a>
                        </div>
                    </div>
                </div>
        ...
        <section id="founder-bio" class="bg-[var(--bg-secondary)] py-20 md:py-32">
        ...
        <section id="contact" class=" py-20 md:py-32 bg-[var(--bg-primary)] text-[var(--text-primary)]">
            <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
                <div>
                    ...
                    <p class="text-lg md:text-xl">Hubungi tim kami untuk konsultasi awal yang komprehensif. Kami siap membantu Anda.</p>
                </div>
                <form class="bg-[var(--bg-secondary)] p-8 md:p-12 rounded-lg shadow-xl text-[var(--text-primary)]">
                    <h3 class="text-2xl font-bold mb-6">Formulir Kontak</h3>
                    <div class="mb-4">
                        <input type="text" placeholder="Nama Lengkap" class="w-full p-3 rounded-lg bg-gray-100 border-2 border-gray-200 focus:outline-none focus:border-[var(--accent)]">
                    </div>
                    <div class="mb-4">
                        <input type="email" placeholder="Alamat Email" class="w-full p-3 rounded-lg bg-gray-100 border-2 border-gray-200 focus:outline-none focus:border-[var(--accent)]">
                    </div>
                    <div class="mb-6">
                        <textarea placeholder="Pesan Anda" rows="4" class="w-full p-3 rounded-lg bg-gray-100 border-2 border-gray-200 focus:outline-none focus:border-[var(--accent)]"></textarea>
                    </div>
    ...
    <!-- Footer -->
    <footer class="bg-[var(--text-primary)] text-gray-300 py-12">
        <div class="container mx-auto px-6">
                ...
                <div class="grid grid-cols-2 gap-4 md:col-span-2">
                    <div>
                        ...
                        <ul class="text-sm space-y-2">
                            <li><a href="#" class="hover:text-[var(--accent)] transition-colors">Beranda</a></li>
                            <li><a href="#" class="hover:text-[var(--accent)] transition-colors">Firma Kami</a></li>
                            <li><a href="#" class="hover:text-[var(--accent)] transition-colors">Layanan</a></li>
                            <li><a href="#" class="hover:text-[var(--accent)] transition-colors">Pengacara</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="text-white font-semibold mb-4">Lainnya</h4>
                        <ul class="text-sm space-y-2">
                            <li><a href="#" class="hover:text-[var(--accent)] transition-colors">Pengakuan</a></li>
                            <li><a href="#" class="hover:text-[var(--accent)] transition-colors">Publikasi</a></li>
                            <li><a href="#" class="hover:text-[var(--accent)] transition-colors">Karir</a></li>
                            <li><a href="#" class="hover:text-[var(--accent)] transition-colors">Kontak</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
                ...
                <div class="flex space-x-4 mt-4 md:mt-0">
                    <a href="#" class="hover:text-[var(--accent)] transition-colors">
