@props(
        [
                    'title' => 'Keahlian Kami',
                    'subtitle' => 'Solusi Hukum Inovatif untuk Tantangan
                    Kompleks', 
                    'desc' => 'Di Ambara Advocate, kami menggabungkan keahlian mendalam dengan
                    ...
                    'class' => 'bg-surface py-8 md:pt-24 md:pb-16'
                    ]
        )
